...
function theme_stylesheets(){
	...
	if( $styles_path ) {
		...
		wp_register_style('bootstrap', ASSETS_URL . '/assets/css/bootstrap.css', array(), false, 'all');
		wp_register_style('style', ASSETS_URL . '/assets/css/style.css', array('bootstrap'), false, 'all');
